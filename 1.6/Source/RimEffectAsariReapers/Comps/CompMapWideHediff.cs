...
namespace RimEffectAR
{
    ...
    public class CompMapWideHediff : ThingComp
    {
        ...
        public override void CompTickRare()
        {
            ...
            if (!Props.affectReapers) pawns = pawns.Where(p => p.RaceProps.FleshType != RimEffectARDefOf.RE_Husk);
            if (!Props.affectNonReapers) pawns = pawns.Where(p => p.RaceProps.FleshType == RimEffectARDefOf.RE_Husk);
