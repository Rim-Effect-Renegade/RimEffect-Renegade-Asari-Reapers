namespace RimEffectAR
{
    ...
    public static class TraderCaravanArrival_Patch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            list.InsertRange(idx1, new[]
            {
                ...
                new CodeInstruction(OpCodes.Ldsfld, AccessTools.Field(typeof(RimEffectARDefOf), nameof(RimEffectARDefOf.RE_AsariRepublics))),
        ...
        {
            var shuttle = (AsariShuttleLanded) ThingMaker.MakeThing(RimEffectARDefOf.RE_AsariShuttleLanded);
            ...
            SkyfallerMaker.SpawnSkyfaller(RimEffectARDefOf.RE_AsariShuttleIncoming, shuttle, cell, map).Rotation = Rot4.North;
        }
    }
        ...
        public override void Tick()
        {
            ...
            switch (State)
            {
                ...
                case ShuttleState.Loading when ToLoad != null && !ToLoad.Any():
                    ...
                    SkyfallerMaker.SpawnSkyfaller(RimEffectARDefOf.RE_AsariShuttleLeaving, this, cell, map).Rotation = Rot4.North;
                    return;
    ...
    public class JobGiver_EnterAsariShuttle : ThinkNode_JobGiver
    {
        ...
        {
            var shuttle = pawn.Map.listerThings.ThingsOfDef(RimEffectARDefOf.RE_AsariShuttleLanded).OfType<AsariShuttleLanded>().FirstOrDefault(t =>
                t.Faction == pawn.Faction && t.State == AsariShuttleLanded.ShuttleState.Loading && t.ToLoad != null && t.ToLoad.Contains(pawn));
            return shuttle != null ? JobMaker.MakeJob(RimEffectARDefOf.RE_EnterShuttle, shuttle) : null;
        }
    }
    ...
    public class LordToil_LeaveOnShuttle : LordToil_ExitMap
    {
        ...
        public override DutyDef ExitDuty => RimEffectARDefOf.RE_LeaveOnShuttle;
    ...
    {
        public override DutyDef ExitDuty => RimEffectARDefOf.RE_LeaveOnShuttleAndDefendSelf;
    }
}