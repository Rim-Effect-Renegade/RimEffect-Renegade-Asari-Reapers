...
namespace RimEffectAR
{
    ...
    public class Ability_Sphere : Ability
    {
        ...
        {
            base.Cast(targets);
            BioticSphere bioticSphere = (BioticSphere) GenSpawn.Spawn(RimEffectARDefOf.RE_Biotic_SphereShield, this.Caster.Position, this.pawn.Map);
    ...
    public class BioticSphere : Thing
    {
        ...
        public override void Destroy(DestroyMode mode = DestroyMode.Vanish)
        {
            if (this.caster != null)
            {
                this.caster.health.hediffSet.hediffs.Remove(this.caster.health.hediffSet.GetFirstHediffOfDef(RimEffectARDefOf.RE_Biotic_SphereHediff));
            }
